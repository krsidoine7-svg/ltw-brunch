...
> **Contexte Chefskrsidoine7** : en mode multi-agents, la phase 0 (cartographie + délégation) est gérée par le manager. Voir [chefskrsidoine7-integration.md](chefskrsidoine7-integration.md).

## Phase 0 — Cartographie (Chefskrsidoine7)
...
Si l'un des déclencheurs Chefskrsidoine7 s'applique, **proposer un diagramme avant le code**.
